...
if(isset($_POST['submit'])){
  ...
  # access token
  $consumerKey = '9LpILiFeiQjHUF1NJucAevA3ALNA2w2c';//'nk16Y74eSbTaGQgc9WF8j6FigApqOMWr'; //Fill with your app Consumer Key
  $consumerSecret = 'GraxZQzZCbP9n7Tx';//'40fD1vRXCq90XFaU'; // Fill with your app Secret
